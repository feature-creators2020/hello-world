...
public class HUpManager : CStateBase<HumanStateManager>
{
    ...
    public HUpManager(HumanStateManager _cOwner) : base(_cOwner) { }
    ...
    public override void Enter()
    {
        ...
        var SubPos = TopPos - (StartPos - new Vector3(0f, m_cOwner.transform.localScale.y, 0f));
        var UpPos = StartPos + new Vector3(0f, SubPos.y, 0f);
        EndPos = UpPos - m_cOwner.m_TargetBoxNomal * (Vector3.Distance(m_cOwner.transform.position, m_cOwner.m_GTargetBoxObject.transform.position) * 0.75f);
